{
  ...
  outputs = { nixpkgs, homelab-dashboard, ... }:
    ...
    in {
      ...
      nixosConfigurations.cloud-media-console = nixpkgs.lib.nixosSystem {
        inherit system;
        ...
        modules = [
          ...
          ./systems/cloud-media-console/hardware-configuration.nix
          ./systems/cloud-media-console/kiosk.nix
          ./systems/cloud-media-console/mpv.nix
